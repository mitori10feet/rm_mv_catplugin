...
Imported._width = 1280;
Imported._height = 720;
...
//     };                                             
		    ...
		    "2" :{ 
            "90":['Safe_hut_01',0,0,0,100,100,255,0,'below_tilemap'],//記住每個圖片要用逗號隔開
            "99":['Safe_hut_02',0,0,0,100,100,255,0,'above_characters'],
        },
    ...
    */
    ...
    Game_Picture.prototype.show = function(name, origin, x, y, scaleX,
        ...
        if (SceneManager._scene instanceof Scene_Map) {
            ...
            this._mapOffsX = Math.max(Imported._width - ($gameMap.width() * $gameMap.tileWidth()), 0);
            this._mapOffsY = Math.max(Imported._height - ($gameMap.height() * $gameMap.tileHeight()), 0);
        }
    };
    /**
